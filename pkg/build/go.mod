...
require (
	...
	google.golang.org/grpc v1.80.0 // indirect; @grafana/grafana-catalog
	google.golang.org/protobuf v1.36.12-0.20260120151049-f2248ac996af // indirect; @grafana/grafana-catalog
)
